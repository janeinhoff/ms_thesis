...
```{r warning = F, message = F}
data_edu <- read.dta("/home/jan/Documents/thesis/2_data/data_share/easySHARE_rel7-1-0_Stata/easySHARE_rel7-1-0.dta")
...
data_family <- read.dta("/home/jan/Documents/thesis/2_data/data_share/sharew7_rel7-1-1_ALL_datasets_stata/sharew7_rel7-1-1_rp.dta")
...
# ill health
```{r warning = F, message = F}
data_health <- read.dta("/home/jan/Documents/thesis/2_data/data_share/sharew7_rel7-1-1_ALL_datasets_stata/sharew7_rel7-1-1_hs.dta")
...
# reason why left job: (in-)voluntary retirement: made redundant (unemployment), own ill health (as in Radl, 2013)
```{r warning = F, message = F}
