...
pdf("outputs/cluster_solutions.pdf") 
plot(seq_cluster, stat = c("ASW", "HC", "PBC", "CH"), norm = "zscoremed", lwd = 1)
dev.off()

seqdplot(seq_history, group = seq_cluster$clustering$cluster4, border = NA)
```
...
work_history <- work_history %>%
  mutate(
    cluster = case_when(
    cluster == 23633 ~ "Domestic exit",
    cluster == 23787~ "Part-time employment exit",
    cluster == 23789 ~ "Full-time employment exit",
    cluster == 23511 ~ "Part-time retirement"))
